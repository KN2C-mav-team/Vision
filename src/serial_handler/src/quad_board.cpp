...
//void Quad_Board::poleSerial_CB(const serial_handler::pole &msg)
//{

    // qDebug()<<"order = "<<msg.setpoint;
    //    load[6]=msg.order;
    //    load[7]=msg.error;
    //    load[8]=msg.setpoint;
    //    load[9]=int(msg.Area/100);
//}
...
void Quad_Board::window_CB(const serial_handler::WinMsg &msg)
{
    ...
    load[2]=msg.setpoint;
    load[3]=msg.setpointy;
    load[4]=msg.flag;
    load[5]=msg.scale;
    load[6]=msg.angle;
    load[7]=msg.upperbound;
}

void Quad_Board::optFlow_CB(const serial_handler::opt_Flow &msg)
{
