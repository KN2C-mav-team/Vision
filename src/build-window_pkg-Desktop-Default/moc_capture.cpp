...
#include "../../../../pole_handler_ws/src/window_pkg/include/capture.h"
...
static const char qt_meta_stringdata_Capture[] = {
    "Capture\0\0imageReadySig(Mat)\0"
};
...
void Capture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->imageReadySig((*reinterpret_cast< Mat(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Capture::imageReadySig(Mat _t1)
{
