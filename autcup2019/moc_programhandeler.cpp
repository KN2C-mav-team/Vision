...
static const char qt_meta_stringdata_ProgramHandeler[] = {
    ...
    "gateStatusCallBack(int)\0movement\0"
...
void ProgramHandeler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->gateStatusCallBack((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->Callback((*reinterpret_cast< const string(*)>(_a[1])),(*reinterpret_cast< const string(*)>(_a[2])),(*reinterpret_cast< const std::vector<cv::Point>(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
    }
}
