...
static const char qt_meta_stringdata_Quad_Board[] = {
    ...
    "lineSerial_CB(double,double,int)\0"
    "dist,angle,hassan\0gateSerial_CB(int)\0"
    "movement\0landingPadSerial_CB(int)\0"
    "land\0optFlow_CB(int,int)\0delta_x,delta_y\0"
};
...
void Quad_Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->lineSerial_CB((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
