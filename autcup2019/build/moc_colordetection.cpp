...
static const char qt_meta_stringdata_ColorDetection[] = {
    "ColorDetection\0"
};
...
const QMetaObjectExtraData ColorDetection::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ColorDetection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ColorDetection,
      qt_meta_data_ColorDetection, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ColorDetection::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorDetection))
