...
static const char qt_meta_stringdata_Handler[] = {
    ...
    "gateStatus(int)\0imageCallback(cv::Mat)\0"
    "frame\0detectYellowRedFrame()\0reduceNoise()\0"
};
...
void Handler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->gateStatus((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->imageCallback((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        case 6: _t->detectYellowRedFrame(); break;
        case 7: _t->reduceNoise(); break;
        default: ;
        }
    }
}
...
// SIGNAL 4
void Handler::gateStatus(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
