...
static const char qt_meta_stringdata_ProgramHandeler[] = {
    "ProgramHandeler\0connectorPkg(double,double,int)\0"
    ",,\0\0imageCallBack(cv::Mat)\0raw_image\0"
    "Callback(string,string,std::vector<cv::Point>,int)\0"
    ",,,\0gateStatusCallBack(int)\0movement\0"
};
...
void ProgramHandeler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->connectorPkg((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        case 3: _t->gateStatusCallBack((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void ProgramHandeler::connectorPkg(double _t1, double _t2, int _t3)
{
